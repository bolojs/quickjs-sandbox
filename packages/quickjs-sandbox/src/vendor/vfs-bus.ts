// Vendored from @bolojs/vfs-bus (packages/vfs-bus/src/vfs-bus.ts in the
// bolo monorepo, not published to npm). The real VfsBus is a much larger
...
// TODO: replace with a real `@bolojs/vfs-bus` npm dependency once that
